...
#define HTTP11_MAX_REQUEST_LINE_LENGTH 3000
#define HTTP11_MAX_METHOD_LENGTH 16
#define HTTP11_MAX_URI_LENGTH 2048
...
enum http11_parse_state
{
    ...
    HTTP11_PARSE_STATE_METHOD,
    HTTP11_PARSE_STATE_URI,
    HTTP11_PARSE_STATE_VERSION,
...
enum http11_parse_error
{
    ...
    HTTP11_PARSE_ERROR_INVALID_METHOD,
    HTTP11_PARSE_ERROR_INVALID_URI,
    HTTP11_PARSE_ERROR_INVALID_VERSION,
